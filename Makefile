...
#    Updated: 2021/11/03 15:10:24 by tnard            ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #
...
SRCSB =	ft_lstmap.c ft_lstiter.c ft_lstclear.c ft_lstdelone.c ft_lstadd_front.c ft_lstlast.c ft_lstsize.c ft_lstnew.c ft_lstadd_front.c $(SRCS)
NAME = libft.a
